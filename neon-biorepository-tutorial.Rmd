...
```{r download Data New},message=FALSE}
...
```{r extract and summarise CN data},message=FALSE,evaluate=TRUE}
...
# Summarize canopy data by year and site
...
# Summarize litter data by year and site
...
We have identified 31 site by year combinations for which we would like to obtain paired mammal hair and fecal samples for further study! Now we will look for available mammal samples.
